...
const tocToggle = document.getElementById("toc-label-bar");
const tocContainer = document.getElementById("TableOfContents");
const tocContent = document.querySelector(".toc-content");
const toc = document.querySelector(".toc");
const tocArrow = document.querySelector(".svg-drop-down")

function openToc() {
  tocContent.classList.toggle("toggleDisplay")
  tocArrow.classList.toggle("flip-arrow")
}
